package cn.example.newsAPP.fragment.news;
...
import cn.example.newsAPP.Utils.DensityUtils;
import cn.example.newsAPP.Utils.LocalCacheUtils;
import cn.example.newsAPP.Utils.LogUtils;
import cn.example.newsAPP.Utils.NetWorkUtil;
import cn.example.newsAPP.Utils.ThreadManager;
import cn.example.newsAPP.Utils.ToastUtils;
import cn.example.newsAPP.activity.NewsDetailActivity;
import cn.example.newsAPP.activity.PicDetailActivity;
import cn.example.newsAPP.adapter.NewsListAdapter;
import cn.example.newsAPP.bean.NewsListNormalBean;
import cn.example.newsAPP.common.Api;
import cn.example.newsAPP.fragment.BaseFragment;
import cn.example.newsAPP.http.DataParse;
import cn.example.newsAPP.http.HttpCallbackListener;
import cn.example.newsAPP.http.HttpHelper;
import cn.example.newsAPP.widget.ClassicRefreshHeaderView;
import cn.example.newsAPP.widget.DividerGridItemDecoration;
import cn.example.newsAPP.widget.LoadMoreFooterView;
import cn.example.newsAPP.widget.LoadingPage;
